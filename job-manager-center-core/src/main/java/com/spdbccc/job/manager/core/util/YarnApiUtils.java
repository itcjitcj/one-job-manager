...
import com.spdbccc.job.manager.core.common.pojo.BackpressureInfo;
...
public class YarnApiUtils {
    ...
    public static HttpYarnApp getApp(String yarnUrl, String user, String name, int retries,String queue,boolean isRunning) {
//        if (queue != null && !"root".equals(queue) && !queue.startsWith("root.")) {
//            queue = "root." + queue;
//        }
        Map<String, Object> params = new HashMap<>();
    ...
    public static  List<HttpYarnApp> getAllApp(String yarnUrl, String user, int retries,String queue,boolean isRunning) {
        Map<String, Object> params = new HashMap<>();
        params.put("user", user);
        params.put("queue", queue);
        if(isRunning){
     ...
     * @return
     */
    public static HttpYarnApp getAppWithAppId(String yarnUrl, String appId) {
    ...
    public static String killApp(String yarnUrl, String appId) {
